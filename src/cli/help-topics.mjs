...
export const CONCEPT_HELP = Object.freeze({
  spr: Object.freeze({
    ...
    topic: 'spr',
    summary:
      'SPR is single-provider review: author and reviewer use distinct sessions or models in the same provider family. Native orchestration is eligible only when that provider can launch and resume the second session; otherwise the project-local broker is required.',
